...
exports.deleteDireitosById = void 0;
const connection_1 = __importDefault(require("../../connection"));
const deleteDireitosById = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { id } = req.params;
        if (!id) {
...
exports.deleteDireitosById = deleteDireitosById;
//# sourceMappingURL=deleteDireitosById.js.map